...
const DialogEditRekening = ({visible, onPress, bank, setBank, rekening, set_rek, nama, setNama, onClick}) => {
  return (
    <TouchableWithoutFeedback onPress={onPress}>
        <ReactNativeModal isVisible={visible}>
            <View style={{flex: 1, backgroundColor: 'transparent', alignItems: 'center', justifyContent: 'center'}}>
                <View style={styles.containerModal} >
                <Text style={{fontSize: 16, color: '#1e1e1e', fontWeight: '500', textAlign: 'center'}}>Edit Rekening</Text>
...
export default DialogEditRekening